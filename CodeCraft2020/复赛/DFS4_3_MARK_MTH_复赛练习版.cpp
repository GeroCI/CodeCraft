...
#define THREAD_NUM 4
#define CS 0.1
#define MAXSIZE7 1024 * 1024 * 1000
#define MAXSIZE6 1024 * 1024 * 300
#define MAXSIZE5 1024 * 1024 * 200
#define MAXSIZE4 1024 * 1024 * 200
#define MAXSiZE3 1024 * 1024 * 100
...
Node *pos1, *pos2, *pos3, *pos4, *pos5, *pos6, *pos7;
Node *end1, *end2, *end3, *end4, *end5, *end6, *end7;
uint32_t k_to,j_to, tt_to;
uint32_t n1, n2, n3, n4 ,n5;
Node p, q, r, s, t, u, v, nd;
uint32_t p_je,q_je,r_je,s_je,t_je, u_je;
uint32_t p_to,q_to,r_to,s_to,t_to, u_to;
/**线程2参数**/
double judge_1 = 0.0;
...
uint32_t *distanceje_1;
bool *visit_1;
int cnt1_1=0,cnt2_1=0,cnt3_1=0,cnt4_1=0,cnt5_1=0;
uint32_t c_len1_1=0,c_len2_1=0,c_len3_1=0,c_len4_1=0,c_len5_1=0;
Node *pos1_1, *pos2_1, *pos3_1, *pos4_1, *pos5_1, *pos6_1, *pos7_1;
Node *end1_1, *end2_1, *end3_1, *end4_1, *end5_1, *end6_1, *end7_1;
uint32_t k_to_1,j_to_1, tt_to_1;
uint32_t n1_1, n2_1, n3_1, n4_1 ,n5_1;
Node p_1, q_1, r_1, s_1, t_1, u_1, v_1, nd_1;
uint32_t p_je_1,q_je_1,r_je_1,s_je_1,t_je_1, u_je_1;
uint32_t p_to_1,q_to_1,r_to_1,s_to_1,t_to_1, u_to_1;
/**线程3参数**/
double judge_2 = 0.0;
...
uint32_t *distanceje_2;
bool *visit_2;
int cnt1_2=0,cnt2_2=0,cnt3_2=0,cnt4_2=0,cnt5_2=0;
uint32_t c_len1_2=0,c_len2_2=0,c_len3_2=0,c_len4_2=0,c_len5_2=0;
Node *pos1_2, *pos2_2, *pos3_2, *pos4_2, *pos5_2, *pos6_2, *pos7_2;
Node *end1_2, *end2_2, *end3_2, *end4_2, *end5_2, *end6_2, *end7_2;
uint32_t k_to_2,j_to_2, tt_to_2;
uint32_t n1_2, n2_2, n3_2, n4_2 ,n5_2;
Node p_2, q_2, r_2, s_2, t_2, u_2, v_2, nd_2;
uint32_t p_je_2,q_je_2,r_je_2,s_je_2,t_je_2, u_je_2;
uint32_t p_to_2,q_to_2,r_to_2,s_to_2,t_to_2, u_to_2;
/**线程4参数**/
double judge_3 = 0.0;
...
uint32_t *distanceje_3;
bool *visit_3;
int cnt1_3=0,cnt2_3=0,cnt3_3=0,cnt4_3=0,cnt5_3=0;
uint32_t c_len1_3=0,c_len2_3=0,c_len3_3=0,c_len4_3=0,c_len5_3=0;
Node *pos1_3, *pos2_3, *pos3_3, *pos4_3, *pos5_3, *pos6_3, *pos7_3;
Node *end1_3, *end2_3, *end3_3, *end4_3, *end5_3, *end6_3, *end7_3;
uint32_t k_to_3,j_to_3, tt_to_3;
uint32_t n1_3, n2_3, n3_3, n4_3 ,n5_3;
Node p_3, q_3, r_3, s_3, t_3, u_3, v_3, nd_3;
uint32_t p_je_3,q_je_3,r_je_3,s_je_3,t_je_3, u_je_3;
uint32_t p_to_3,q_to_3,r_to_3,s_to_3,t_to_3, u_to_3;
...
inline void parseInput(){
    ...
    distanceje = (uint32_t *)malloc(sizeof(uint32_t) * nodecnt);
    distancej_1 = (uint32_t *)malloc(sizeof(uint32_t) * nodecnt);
    distanceje_1 = (uint32_t *)malloc(sizeof(uint32_t) * nodecnt);
    distancej_2 = (uint32_t *)malloc(sizeof(uint32_t) * nodecnt);
    distanceje_2 = (uint32_t *)malloc(sizeof(uint32_t) * nodecnt);
    distancej_3 = (uint32_t *)malloc(sizeof(uint32_t) * nodecnt);
    distanceje_3 = (uint32_t *)malloc(sizeof(uint32_t) * nodecnt);
        ...
        for (pos2=gp; pos2 < end2; ++pos2) {
            ...
            for (pos3 = gq; pos3 < end3; ++pos3) {//i-p-q
                ...
                for (pos4 = gr; pos4 < end4; pos4++) {//begin remove node
                    s = *pos4;//i-p-q-r-s
                    s_to = s.to;
                    if (s_to < i || visit[s_to]||distancej[s_to]>3) continue;
                    s_je = s.je;
#ifdef JEJUDGE
                    judge = 1.0 * s_je/r_je;
                    if(judge<MINJE || judge>MAXJE) continue;
                    ...
                    for(pos5 = gs; pos5<end5; pos5++){
                        t = *pos5;
                        t_to = t.to;
                        if(t_to <i ||visit[t_to]||distancej[t_to]>2) continue;
                        t_je = t.je;
                        //(s)-t-u-i不需要再判断内部节点
                        judge = 1.0 * t_je / s_je;
                        if(judge<MINJE || judge>MAXJE) continue;
                        ...
                        for(pos6 = gt; pos6<end6; pos6++){
                            u = *pos6;
                            u_to = u.to;
                            if(u_to <i ||visit[u_to]||distancej[u_to]>1) continue;
                            u_je = u.je;
                            judge = 1.0 * u_je / t_je;
                            if(judge<MINJE || judge>MAXJE) continue;
                            if(u_to == i){
        ...
        for (pos2_1=end2_1-1; pos2_1 >= gp; --pos2_1) {
            ...
            for (pos3_1 = end3_1-1; pos3_1 >= gq; --pos3_1) {//i-p-q
                ...
                for (pos4_1 = end4_1-1; pos4_1 >= gr; --pos4_1) {//begin remove node
                    ...
                    s_to_1 = s_1.to;
                    if (s_to_1 < i || visit_1[s_to_1]||distancej_1[s_to_1]>3) continue;
                    s_je_1 = s_1.je;
#ifdef JEJUDGE
                    ...
                    for(pos5_1=end5_1-1; pos5_1>=gs; --pos5_1){
                        t_1 = *pos5_1;
                        t_to_1 = t_1.to;
                        if(t_to_1 <i ||visit_1[t_to_1]||distancej_1[t_to_1]>2) continue;
                        t_je_1 = t_1.je;
                        //(s)-t-u-i不需要再判断内部节点
                        ...
                        for(pos6_1 = end6_1-1; pos6_1>=gt; --pos6_1){
                            u_1 = *pos6_1;
                            u_to_1 = u_1.to;
                            if(u_to_1 <i ||visit_1[u_to_1]||distancej_1[u_to_1]>1) continue;
                            u_je_1 = u_1.je;
                            ...
                            for(pos7_1=end7_1-1; pos7_1>=gu;--pos7_1){
                                v_1 = *pos7_1;
                                if (v_1.to != i) continue;
                                judge_1 = 1.0*v_1.je/u_je_1;
                                if(judge_1<MINJE || judge_1>MAXJE) continue;
                                judge_1 =1.0*p_je_1/v_1.je;
                                if(judge_1<MINJE || judge_1>MAXJE) continue;
        ...
        for (pos2_2=gp; pos2_2 < end2_2; ++pos2_2) {
            ...
            for (pos3_2 = gq; pos3_2 < end3_2; ++pos3_2) {//i-p-q
                ...
                for (pos4_2 = gr; pos4_2 < end4_2; pos4_2++) {//begin remove node
                    ...
                    s_to_2 = s_2.to;
                    if (s_to_2 < i || visit_2[s_to_2]||distancej_2[s_to_2]>3) continue;
                    s_je_2 = s_2.je;
#ifdef JEJUDGE
                    ...
                    for(pos5_2 = gs; pos5_2<end5_2; pos5_2++){
                        t_2 = *pos5_2;
                        t_to_2 = t_2.to;
                        if(t_to_2 <i ||visit_2[t_to_2]||distancej_2[t_to_2]>2) continue;
                        t_je_2 = t_2.je;
                        //(s)-t-u-i不需要再判断内部节点
                        ...
                        for(pos6_2 = gt; pos6_2<end6_2; pos6_2++){
                            u_2 = *pos6_2;
                            u_to_2 = u_2.to;
                            if(u_to_2 <i ||visit_2[u_to_2]||distancej_2[u_to_2]>1) continue;
                            u_je_2 = u_2.je;
                            ...
                            for(pos7_2=gu;pos7_2<end7_2;pos7_2++){
                                v_2 = *pos7_2;
                                if (v_2.to != i) continue;
                                judge_2 = 1.0*v_2.je/u_je_2;
                                if(judge_2<MINJE || judge_2>MAXJE) continue;
                                judge_2 =1.0*p_je_2/v_2.je;
                                if(judge_2<MINJE || judge_2>MAXJE) continue;
                                auto res = idsComma[i];
        ...
        for (pos2_3=end2_3-1; pos2_3 >= gp; --pos2_3) {
            ...
            for (pos3_3 = end3_3-1; pos3_3 >= gq; --pos3_3) {//i-p-q
                ...
                for (pos4_3 = end4_3-1; pos4_3 >= gr; --pos4_3) {//begin remove node
                    ...
                    s_to_3 = s_3.to;
                    if (s_to_3 < i || visit_3[s_to_3]||distancej_3[s_to_3]>3) continue;
                    s_je_3 = s_3.je;
#ifdef JEJUDGE
                    ...
                    for(pos5_3=end5_3-1; pos5_3>=gs; --pos5_3){
                        t_3 = *pos5_3;
                        t_to_3 = t_3.to;
                        if(t_to_3 <i ||visit_3[t_to_3]||distancej_3[t_to_3]>2) continue;
                        t_je_3 = t_3.je;
                        //(s)-t-u-i不需要再判断内部节点
                        ...
                        for(pos6_3 = end6_3-1; pos6_3>=gt; --pos6_3){
                            u_3 = *pos6_3;
                            u_to_3 = u_3.to;
                            if(u_to_3 <i ||visit_3[u_to_3]||distancej_3[u_to_3]>1) continue;
                            u_je_3 = u_3.je;
                            ...
                            for(pos7_3=end7_3-1; pos7_3>=gu;--pos7_3){
                                v_3 = *pos7_3;
                                if (v_3.to != i) continue;
                                judge_3 = 1.0*v_3.je/u_je_3;
                                if(judge_3<MINJE || judge_3>MAXJE) continue;
                                judge_3 =1.0*p_je_3/v_3.je;
                                if(judge_3<MINJE || judge_3>MAXJE) continue;
